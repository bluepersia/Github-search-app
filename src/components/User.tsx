    ...
    <div className={styles.user + ' ' + styles[mode.toString()]}>
      ...
      <main className={styles.main}>
        <div className={styles.stat}>
          <p className={styles.stat_label}>Repos</p>
          <h2 className={styles.stat_value}>{user.public_repos}</h2>
        </div>
        <div className={styles.stat}>
          <p className={styles.stat_label}>Followers</p>
          <h2 className={styles.stat_value}>{user.followers}</h2>
        </div>
        <div className={styles.stat}>
          <p className={styles.stat_label}>Following</p>
          <h2 className={styles.stat_value}>{user.following}</h2>
        </div>
      </main>

      <footer className={styles.footer}>
        <Link className={styles.location} unavailable={!user.location}>
        ...
        <Link
          ...
          url={
            user.twitter_username
              ? `http://www.twitter.com/${user.twitter_username}`
              : ''
          }
        ...
        <Link className={styles.company} unavailable={!user.company}>
          <svg height='20' width='20' xmlns='http://www.w3.org/2000/svg'>
            <g fill='#4b6a9b'>
