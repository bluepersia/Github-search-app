...
import imgLink from '../assets/img/icon-website.svg';
import { PropsWithChildren, useContext } from 'react';
import { AppContext } from '../App';

export default function Link({ children }: PropsWithChildren): JSX.Element {
  const { mode } = useContext(AppContext);
  return (
    <a href='#' className={styles.link + ' ' + styles[mode.toString()]}>
      <svg
